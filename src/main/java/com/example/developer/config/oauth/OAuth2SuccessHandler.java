package com.example.developer.config.oauth;
...
import com.example.developer.util.CookieUtil;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler{
    ...
    public void onAuthenticationSuccess(HttpServletRequest request,
        ...
        User user = userService.findByEmail((String) oAuth2User.getAttributes().get("emial"));
